...
5. Так SVD разложение детерменировано, а значения $$s_t$$ упорядочены, то выбор параметра $$K$$ не влияет на сами темы --- если выбрать $$K=3$$ и $$K=100$$, то первые три темы в обоих случаях будут одинаковы.
...
1. [IPython Notebook](https://github.com/Obus/Topic_Modelling_Game_of_Thrones/blob/master/Song%20of%20Ice%20and%20Fire%20Topic%20Modelling.ipynb) с кодом, используемым для этой статье, и полученными результатами.
